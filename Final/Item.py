...
ItemIndex.append(Item(12,"랜덤상자","획득시 무작위 아이템을 획득한다.",1))
...
ItemIndex.append(Item(15,"관통","탄막에 관통능력을 얻는다.",2))
ItemIndex.append(Item(16,"자유의 날개","일정확률로 피격을 무효화한다.",2))
ItemIndex.append(Item(17,"부적[수호2]","피격시 플레이어 주변의 넓은 범위의 탄막이 사라진다, [레어] 부적[수호]가 존재하는 경우 피격시 맵상의 모든 탄막을 제거한다.",2))
ItemIndex.append(Item(22,"신비의 악보","최대체력 +1, 2발의 유도탄을 발사한다.",2))
#전설 2

ItemIndex.append(Item(18,"관통","탄막에 관통능력을 얻는다.",3))
ItemIndex.append(Item(19,"자유의 날개","일정확률로 피격을 무효화한다.",3))
