                ...
                if(Monster.Attack() >= 0):#basic attack
                    ...
                    if(Monster.AttackType == 0):
                        ...
                        if(random.randint(0,2)==0):
                            for j in range(0,40):
                                self.SetMonsterBullet(Monster.X, Monster.Y, 5*math.sin(math.radians(j*360//40)),-5*math.cos(math.radians(j*360//40)), 1, 30, 30,3)
                        else:
                            for j in range(0,40):
                                self.SetMonsterBullet(Monster.X, Monster.Y, 5.5*math.sin(math.radians(j*360//40)),-5.5*math.cos(math.radians(j*360//40)), 1, 30, 30,3)
                    elif (Monster.AttackType == 3):
                            for j in range(0, 100):
                                self.SetMonsterBullet(Monster.X, Monster.Y, (6+(-5+j%10)*0.5) * math.sin(math.radians(j * 360 // 50)),
                                                      (6 + (-5 + j % 10) * 0.5) * math.cos(math.radians(j * 360 // 50)), 1, 30, 30,3)
                            Monster.AttackType = 4
                    elif (Monster.AttackType == 4):
                            for j in range(0, 100):
                                self.SetMonsterBullet(Monster.X, Monster.Y,
                                                      (2 * (-5 + (100-j) % 10) * 0.5) * math.sin(math.radians(j * 360 // 50)),
                                                      (2 * (-5 + (100 - j) % 10) * 0.5) * math.cos(math.radians(j * 360 // 50)), 1, 14, 14,3)
    ...
    def MonsterSet(self):
        if(self.g_Level == 0):
            ...
            if(Global.g_Hard >= 2):
                ...
                self.g_MonsterPool[42].SetDir(0, -0.5)
                for i in range(0, 3):
                    self.g_MonsterPool[90 + i].Set(50 + 100 * i, 820, 50 + 25 * self.g_Hard, 40 + i * 0.2, 0, 0.1)
                    self.g_MonsterPool[90 + i].SetDir(-0.1, -1.5)

            self.g_Boss.life = 1#000 + 1000 * Global.g_Level + 300 * Global.g_Hard
                                            ...
                                            for angle in range(0,360,40):
                                                self.SetMonsterBullet(self.g_Boss.X + (20) * math.sin(math.radians(angle)), self.g_Boss.Y + (20) * math.cos(math.radians(angle)),
                                                                  ...
                                                                  (self.g_Player.Y - self.g_Boss.Y) / abs(
                                                                      self.g_Player.Y - self.g_Boss.Y), 10,
                                                                  20, 20, 0)
                        elif (self.g_Boss.AttackType <= 18):
                            self.g_Boss.AttackCycle = 30
                            for i in range(len(self.g_Boss.SkillCycle)):
                                if (self.g_Boss.SkillCycle[i] < self.g_Boss.SkillDelay[i]):
                                    self.g_Boss.SkillDelay[i] = 0
                                    if (i == 0):
